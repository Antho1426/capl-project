    ...
    public void onDemoSelected(View view) {
        ...
        switch (iw.getId()) {
            ...
            case R.id.btn_information:
                ...
                break;
            // EVENTSERVICE_SERVICE_UUID (as the "GamepadControllerActivity") --> Could be useful to implement the "FreeGameActivity"
            case R.id.btn_temperature_alarm:
                ...
                break;
            // EVENTSERVICE_SERVICE_UUID (as the "GamepadControllerActivity") --> Could be useful to implement the "GeographyGameActivity"
